  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
      ...
      <section className="relative min-h-[85vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden pt-24 md:pt-16 md:pb-8">
        ...
        <div className="absolute top-20 right-2 w-4 h-4 sm:top-20 sm:right-12 sm:w-12 sm:h-12 border-r-2 border-t-2 border-accent pointer-events-none" />
        <div className="absolute bottom-4 left-2 w-4 h-4 sm:bottom-20 sm:left-12 sm:w-12 sm:h-12 border-l-2 border-b-2 border-accent pointer-events-none" />
        <div className="absolute bottom-4 right-2 w-4 h-4 sm:bottom-20 sm:right-12 sm:w-12 sm:h-12 border-r-2 border-b-2 border-accent pointer-events-none" />
